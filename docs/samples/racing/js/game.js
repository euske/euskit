...
var Blinker = /** @class */ (function (_super) {
    ...
    function Blinker(entity) {
        var _this = _super.call(this, entity.pos) || this;
        _this.interval = 1.0;
        _this.sprites = entity.sprites;
        return _this;
    }
    Blinker.prototype.isVisible = function () {
        return (this.isRunning() &&
            ((this.interval <= 0) ||
                (phase(this.getTime(), this.interval) != 0)));
    };
...
//  Tweener
//
var Tweener = /** @class */ (function (_super) {
    ...
    Tweener.prototype.onStart = function () {
        _super.prototype.onStart.call(this);
        this.srcpos = this.entity.pos.copy();
    };
    Tweener.prototype.onTick = function () {
        _super.prototype.onTick.call(this);
        if (this.srcpos !== null && this.dstpos !== null) {
            var t = this.getTime() / this.lifetime;
            this.entity.pos = this.getPos(t);
        }
    };
    Tweener.prototype.getPos = function (t) {
...
//  PolyTweener
//
var PolyTweener = /** @class */ (function (_super) {
    __extends(PolyTweener, _super);
    function PolyTweener(entity, n) {
        if (n === void 0) { n = 2; }
...
//  PolyTweenerIn
//
var PolyTweenerIn = /** @class */ (function (_super) {
    __extends(PolyTweenerIn, _super);
    function PolyTweenerIn() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PolyTweenerIn.prototype.getPos = function (t) {
        t = Math.pow(t, this.n);
        return this.srcpos.lerp(this.dstpos, t);
    };
    return PolyTweenerIn;
}(PolyTweener));
//  PolyTweenerOut
//
var PolyTweenerOut = /** @class */ (function (_super) {
    __extends(PolyTweenerOut, _super);
    function PolyTweenerOut() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PolyTweenerOut.prototype.getPos = function (t) {
        t = 1.0 - Math.pow(1.0 - t, this.n);
        return this.srcpos.lerp(this.dstpos, t);
    };
    return PolyTweenerOut;
}(PolyTweener));
//  PolyTweenerInOut
//
var PolyTweenerInOut = /** @class */ (function (_super) {
    __extends(PolyTweenerInOut, _super);
    function PolyTweenerInOut() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PolyTweenerInOut.prototype.getPos = function (t) {
        if (t < 0.5) {
...
var Player = /** @class */ (function (_super) {
    ...
    function Player(pos) {
        ...
        var sprite = SPRITES.get(0, 0, 1, 1, new Vec2(8, 8));
...
var Track = /** @class */ (function (_super) {
    ...
    function Track(width, height) {
        ...
        _this = _super.call(this, 16, width, height, map) || this;
        _this.offset = 0;
        _this.brx = 1;
        _this.brw = width - 2;
        _this.brmw = width;
    ...
    Track.prototype.isFloor = function (rect) {
        return this.findTileByCoord(function (c) { return c == FLOOR; }, rect);
    };
    Track.prototype.proceed = function (speed) {
        this.offset += speed;
        if (16 <= this.offset) {
            var dy = (this.offset % 16);
            var dh = int((this.offset - dy) / 16);
            this.shift(0, dh);
            // Generate new tiles.
            for (var y = 0; y < dh; y++) {
    ...
    Track.prototype.render = function (ctx) {
        ...
        this.renderFromTopRight(ctx, function (x, y, c) { return (c == FLOOR) ? null : SPRITES.get(c); });
        // Render the bridge.
        this.renderFromTopRight(ctx, function (x, y, c) { return (c != FLOOR) ? null : SPRITES.get(c); });
        ctx.restore();
    };
...
//  Racing
//
var Racing = /** @class */ (function (_super) {
    __extends(Racing, _super);
    function Racing() {
        var _this = _super.call(this) || this;
        _this.scoreBox = new TextBox(_this.screen.inflate(-2, -2), FONT);
        _this.highScoreBox = new TextBox(_this.screen.inflate(-2, -2), FONT);
        _this.highScore = -1;
        return _this;
    }
    Racing.prototype.onStart = function () {
        _super.prototype.onStart.call(this);
        this.player = new Player(this.world.area.center());
        this.add(this.player);
        this.track = new Track(int(this.screen.width / 16), int(this.screen.height / 16) + 2);
        this.score = 0;
        this.updateScore();
        APP.setMusic('music', 0, 19.1);
    };
    Racing.prototype.onTick = function () {
        var _this = this;
        _super.prototype.onTick.call(this);
        if (this.player.isRunning()) {
            var b = this.player.getCollider().move(0, this.track.offset);
            if (this.track.isFloor(b)) {
                var speed = int((1.0 - this.player.pos.y / this.screen.height) * 16);
                this.track.proceed(speed);
                this.score += int(lowerbound(0, Math.sqrt(speed) - 2));
                this.updateScore();
            }
            else {
                var blinker = new Blinker(this.player);
                blinker.interval = 0.2;
                blinker.lifetime = 1.0;
                blinker.stopped.subscribe(function () { _this.reset(); });
    ...
    Racing.prototype.onDirChanged = function (v) {
        this.player.setMove(v);
    };
    Racing.prototype.render = function (ctx) {
        ctx.fillStyle = 'rgb(0,0,0)';
        fillRect(ctx, this.screen);
    ...
    Racing.prototype.updateScore = function () {
        this.scoreBox.clear();
