...
var EnemyBase = /** @class */ (function (_super) {
    ...
    function EnemyBase(pos) {
        var _this = _super.call(this, pos) || this;
        _this.killed = new Signal(_this);
        return _this;
    }
    EnemyBase.prototype.getFrame = function () {
        return this.world.area;
    };
    EnemyBase.prototype.onCollided = function (entity) {
...
var Shooter = /** @class */ (function (_super) {
    ...
    Shooter.prototype.onStart = function () {
        var _this = this;
        _super.prototype.onStart.call(this);
    ...
    Shooter.prototype.onTick = function () {
        var _this = this;
        _super.prototype.onTick.call(this);
    ...
    Shooter.prototype.onButtonPressed = function (keysym) {
        this.player.setFire(true);
    };
    Shooter.prototype.onButtonReleased = function (keysym) {
        this.player.setFire(false);
    };
    Shooter.prototype.onDirChanged = function (v) {
        this.player.setMove(v);
    };
    Shooter.prototype.updateScore = function () {
        // Update the text in the score box.
        this.scoreBox.clear();
        this.scoreBox.putText(['SCORE:' + format(this.score)]);
    };
    Shooter.prototype.render = function (ctx) {
