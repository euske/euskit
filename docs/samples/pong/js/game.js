...
var Paddle = /** @class */ (function (_super) {
    ...
    function Paddle(screen) {
        var _this = 
        // Initializes the position and shape.
        _super.call(this, screen.anchor('s').move(0, -20)) || this;
        var bounds = new Rect(-20, -5, 40, 10);
        _this.sprites = [new RectSprite('green', bounds)];
    ...
    Paddle.prototype.onTick = function () {
        ...
        var pos = this.pos.move(this.vx * 4, 0);
...
var Ball = /** @class */ (function (_super) {
    ...
    function Ball(screen) {
        var _this = 
        // Initializes the position and shape.
        _super.call(this, screen.center()) || this;
        var bounds = new Rect(-5, -5, 10, 10);
        _this.sprites = [new OvalSprite('white', bounds)];
        _this.collider = bounds;
        _this.screen = screen;
        _this.v = new Vec2(rnd(2) * 8 - 4, -4);
        return _this;
    }
    Ball.prototype.onTick = function () {
        _super.prototype.onTick.call(this);
        // Updates the position.
        var pos = this.pos.add(this.v);
        var bounds = this.getCollider(pos).getAABB();
    ...
    Ball.prototype.onCollided = function (entity) {
...
var Pong = /** @class */ (function (_super) {
    ...
    Pong.prototype.onStart = function () {
        _super.prototype.onStart.call(this);
        // Places the objects.
    ...
    Pong.prototype.onTick = function () {
        _super.prototype.onTick.call(this);
    ...
    Pong.prototype.onDirChanged = function (v) {
        // Changes the paddle direction.
        this.paddle.vx = v.x;
    };
    Pong.prototype.render = function (ctx) {
