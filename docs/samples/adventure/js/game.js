...
//  PictureScene
//
var PictureScene = /** @class */ (function (_super) {
    __extends(PictureScene, _super);
    function PictureScene() {
        var _this = _super.call(this) || this;
        _this.image0 = null;
        _this.image1 = null;
        _this.alpha = 0;
        ...
        var lineSpace = 4;
        var padding = 8;
        var width = _this.screen.width - 16;
        var height = (lineHeight + lineSpace) * 6 - lineSpace + padding * 2;
        var rect = _this.screen.resize(width, height, 's').move(0, -8);
        var textbox = new TextBox(rect, FONT);
        textbox.padding = padding;
        textbox.lineSpace = lineSpace;
        textbox.background = 'rgba(0,0,0,0.5)';
        _this.dialogBox = new DialogBox(textbox, HIFONT);
        return _this;
    }
    PictureScene.prototype.onStart = function () {
        _super.prototype.onStart.call(this);
        this.add(this.dialogBox);
    };
    PictureScene.prototype.onTick = function () {
        _super.prototype.onTick.call(this);
        if (this.alpha < 1.0) {
            this.alpha = upperbound(1.0, this.alpha + 0.05);
        }
    };
    PictureScene.prototype.onKeyDown = function (key) {
        _super.prototype.onKeyDown.call(this, key);
        this.dialogBox.onKeyDown(key);
    };
    PictureScene.prototype.onMouseDown = function (p, button) {
        _super.prototype.onMouseDown.call(this, p, button);
        this.dialogBox.onMouseDown(p, button);
    };
    PictureScene.prototype.onMouseUp = function (p, button) {
        _super.prototype.onMouseUp.call(this, p, button);
        this.dialogBox.onMouseUp(p, button);
    };
    PictureScene.prototype.onMouseMove = function (p) {
        _super.prototype.onMouseMove.call(this, p);
        this.dialogBox.onMouseMove(p);
    };
    PictureScene.prototype.render = function (ctx) {
        ctx.fillStyle = 'rgb(0,0,0)';
        fillRect(ctx, this.screen);
        ctx.save();
        if (this.image0 !== null) {
            ctx.globalAlpha = 1.0 - this.alpha;
            ctx.drawImage(this.image0, this.screen.x, this.screen.y, this.screen.width, this.screen.height);
        }
        if (this.image1 !== null) {
            ctx.globalAlpha = this.alpha;
            ctx.drawImage(this.image1, this.screen.x, this.screen.y, this.screen.width, this.screen.height);
        }
        ctx.restore();
        _super.prototype.render.call(this, ctx);
        // draw a textbox border.
        var rect = this.dialogBox.textbox.frame.inflate(-2, -2);
        ctx.strokeStyle = 'white';
        ctx.lineWidth = 2;
        strokeRect(ctx, rect);
    };
    PictureScene.prototype.changeScene = function (scene) {
        if (scene instanceof PictureScene) {
            scene.image0 = this.image1;
        }
        _super.prototype.changeScene.call(this, scene);
    };
    return PictureScene;
}(GameScene));
//  Scene1
...
var Scene1 = /** @class */ (function (_super) {
    ...
    function Scene1() {
        var _this = _super.call(this) || this;
        _this.image1 = APP.images['scene1'];
        return _this;
    }
    Scene1.prototype.onStart = function () {
        var _this = this;
        _super.prototype.onStart.call(this);
        this.dialogBox.addDisplay('It was a perfect sunny day. ' +
            'I was driving a sleepy countryside.', 10);
        var menu = this.dialogBox.addMenu();
        ...
        menu.selected.subscribe(function () {
            _this.changeScene(new Scene2());
        });
    };
    return Scene1;
}(PictureScene));
...
var Scene2 = /** @class */ (function (_super) {
    ...
    function Scene2() {
        var _this = _super.call(this) || this;
        _this.image1 = APP.images['scene2'];
        return _this;
    }
    Scene2.prototype.onStart = function () {
        var _this = this;
        _super.prototype.onStart.call(this);
        this.dialogBox.addDisplay('I was fed up with cities. The beauty of ' +
...
var Scene3 = /** @class */ (function (_super) {
    ...
    function Scene3() {
        var _this = _super.call(this) || this;
        _this.image1 = APP.images['scene3'];
        return _this;
    }
    Scene3.prototype.onStart = function () {
        var _this = this;
        _super.prototype.onStart.call(this);
        this.dialogBox.addDisplay('But eventually, people can\'t really ' +
...
var Adventure = /** @class */ (function (_super) {
    ...
    Adventure.prototype.onStart = function () {
        _super.prototype.onStart.call(this);
