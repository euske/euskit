...
var FONT;
var SPRITES;
var TILES = new ArraySpriteSheet([null, new RectSprite('red', new Rect(0, 0, 16, 16))]);
addInitHook(function () {
    FONT = new Font(APP.images['font'], 'white');
    SPRITES = new ImageSpriteSheet(APP.images['sprites'], new Vec2(16, 16), new Vec2(8, 8));
});
function isTerrain(c) {
    return (c != 0);
}
//  Explosion
//
...
var Enemy = /** @class */ (function (_super) {
    ...
    function Enemy(pos) {
        var _this = _super.call(this, pos) || this;
        _this.killed = new Signal(_this);
        return _this;
    }
    Enemy.prototype.getFrame = function () {
        return this.world.area;
    };
    Enemy.prototype.onCollided = function (entity) {
...
var Enemy1 = /** @class */ (function (_super) {
    ...
    function Enemy1(pos) {
        var _this = _super.call(this, pos) || this;
        var sprite = SPRITES.get(2);
        _this.sprites = [sprite];
        _this.collider = sprite.getBounds().inflate(-2, -2);
        _this.movement = new Vec2(-rnd(1, 8), rnd(3) - 1);
        return _this;
    }
    return Enemy1;
}(Enemy));
...
var Enemy2 = /** @class */ (function (_super) {
    ...
    function Enemy2(pos) {
        var _this = _super.call(this, pos) || this;
        var sprite = SPRITES.get(3);
        _this.sprites = [sprite];
        _this.collider = sprite.getBounds().inflate(-2, -2);
        _this.movement = new Vec2(-rnd(1, 4), 0);
        return _this;
    }
    Enemy2.prototype.onTick = function () {
        _super.prototype.onTick.call(this);
...
var Missile = /** @class */ (function (_super) {
    ...
    function Missile(pos, threshold) {
        var _this = _super.call(this, pos) || this;
        var sprite = SPRITES.get(5);
        _this.sprites = [sprite];
        _this.collider = sprite.getBounds();
        _this.threshold = threshold;
        return _this;
    }
    Missile.prototype.onTick = function () {
        _super.prototype.onTick.call(this);
...
var Bullet = /** @class */ (function (_super) {
    ...
    function Bullet(pos) {
        var _this = _super.call(this, pos) || this;
        var bounds = new Rect(-4, -1, 8, 2);
        _this.sprites = [new RectSprite('white', bounds)];
        _this.collider = bounds;
        _this.movement = new Vec2(8, 0);
        return _this;
    }
...
var Bomb = /** @class */ (function (_super) {
    ...
    function Bomb(tilemap, pos) {
        var _this = _super.call(this, tilemap, null, pos) || this;
        var bounds = new Rect(-3, -2, 6, 4);
        _this.sprites = [new RectSprite('cyan', bounds)];
        _this.collider = bounds;
        _this.movement = new Vec2(2, 0);
        return _this;
    }
    Bomb.prototype.onTick = function () {
        _super.prototype.onTick.call(this);
        this.movePos(this.movement);
...
var Player = /** @class */ (function (_super) {
    ...
    function Player(tilemap, pos) {
        ...
        _this.firing = false;
        _this.droping = false;
        _this.nextfire = 0; // Firing counter
        _this.nextdrop = 0; // Droping counter
    ...
    Player.prototype.onTick = function () {
        ...
        if (this.droping) {
            if (this.nextdrop == 0) {
                ...
                var bomb = new Bomb(this.tilemap, this.pos);
                this.world.add(bomb);
                APP.playSound('bomb');
                this.nextdrop = 10;
            }
    ...
    Player.prototype.setFire = function (firing) {
        this.firing = firing;
        if (!this.firing) {
    ...
    Player.prototype.setDrop = function (droping) {
    ...
    Player.prototype.setGoal = function (p) {
        this.goalpos = p.copy();
    };
    ...
    Player.prototype.onTileCollided = function () {
        APP.playSound('explosion');
        this.chain(new Explosion(this.pos));
        this.stop();
    };
...
//  Scramble
//
var Scramble = /** @class */ (function (_super) {
    __extends(Scramble, _super);
    function Scramble() {
        var _this = _super.call(this) || this;
        _this.tilesize = 16;
        _this.scoreBox = new TextBox(_this.screen.inflate(-8, -8), FONT);
        return _this;
    }
    Scramble.prototype.onStart = function () {
        var _this = this;
        _super.prototype.onStart.call(this);
        this.world.area = new Rect(0, 0, this.screen.width + this.tilesize, this.screen.height);
        this.terrain = new TileMap(this.tilesize, 1 + int(this.world.area.width / this.tilesize), int(this.world.area.height / this.tilesize));
        this.player = new Player(this.terrain, this.world.area.center());
        var task = new Task();
        task.lifetime = 2;
        task.stopped.subscribe(function () { _this.reset(); });
    ...
    Scramble.prototype.onTick = function () {
        _super.prototype.onTick.call(this);
        this.player.movePos(new Vec2(this.speed, 0));
        this.world.moveAll(new Vec2(-this.speed, 0));
        this.tx += this.speed;
        var d = int(this.tx / this.tilesize);
        if (0 < d) {
            var dx = -d * this.tilesize;
            this.tx += dx;
            this.terrain.shift(-d, 0);
            for (var x = this.terrain.width - d; x < this.terrain.width; x++) {
                this.addTerrain(x);
            }
        }
        if (this.spawning == 0) {
    ...
    Scramble.prototype.onButtonPressed = function (keysym) {
        switch (keysym) {
            case KeySym.Action1:
    ...
    Scramble.prototype.onButtonReleased = function (keysym) {
        switch (keysym) {
            case KeySym.Action1:
    ...
    Scramble.prototype.onDirChanged = function (v) {
        this.player.setMove(v);
    };
    Scramble.prototype.onMouseDown = function (p, button) {
        _super.prototype.onMouseDown.call(this, p, button);
        this.player.setFire(true);
        this.player.setDrop(true);
    };
    Scramble.prototype.onMouseUp = function (p, button) {
        _super.prototype.onMouseUp.call(this, p, button);
        this.player.setFire(false);
        this.player.setDrop(false);
    };
    Scramble.prototype.onMouseMove = function (p) {
        this.player.setGoal(p);
    };
    Scramble.prototype.updateScore = function () {
        this.scoreBox.clear();
        this.scoreBox.putText(['SCORE:' + format(this.score)]);
    };
    Scramble.prototype.addTerrain = function (x) {
        var _this = this;
        var y = this.terrain.height - this.theight;
        this.terrain.fill(1, new Rect(x, y, 1, this.theight));
        this.theight = clamp(1, this.theight + rnd(3) - 1, 10);
        var rect = this.terrain.map2coord(new Vec2(x, y - 1));
        var enemy = null;
        switch (rnd(4)) {
            case 1:
        ...
        if (enemy !== null) {
            enemy.killed.subscribe(function () { _this.score++; _this.updateScore(); });
            this.add(enemy);
        }
    };
    Scramble.prototype.spawnEnemy = function () {
        var _this = this;
        var area = this.world.area;
        var pos = new Vec2(area.width, rnd(area.height));
        var enemy;
        switch (rnd(2)) {
            case 1:
    ...
    Scramble.prototype.render = function (ctx) {
        ctx.fillStyle = 'rgb(0,0,32)';
        fillRect(ctx, this.screen);
        var dx = this.tx % this.tilesize;
        ctx.save();
        ctx.translate(-dx, 0);
